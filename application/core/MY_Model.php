...
class MY_Model extends CI_Model
{
	...
	/* created_at updated_at deleted_at names */
	public $created_at = 'date_added';
	public $updated_at = 'date_modified';
	public $deleted_at = 'date_deleted';
	...
	private function _set_timestamps()
	{
		if($this->timestamps !== FALSE)
		{
			$this->_created_at_field = (is_array($this->timestamps) && isset($this->timestamps[0])) ? $this->timestamps[0] : $this->created_at;
			$this->_updated_at_field = (is_array($this->timestamps) && isset($this->timestamps[1])) ? $this->timestamps[1] : $this->updated_at;
			$this->_deleted_at_field = (is_array($this->timestamps) && isset($this->timestamps[2])) ? $this->timestamps[2] : $this->deleted_at;
		}
		return TRUE;
	}

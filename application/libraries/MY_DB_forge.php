...
abstract class CI_DB_forge {
	...
	{
		$this->add_field("`date_added` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP");
		$this->add_field("`date_modified` TIMESTAMP on update CURRENT_TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP");
	}
